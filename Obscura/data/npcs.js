...
const NPCS = {
    Origami_Crow: {
        ...
        texture: 'assets/Origami_Crow.png', position: { x: 4, y: 2.5, z: 4 }, scale: 2.8,
        glb: 'assets/Origami_Crow.glb', glbScale: 6.0, glbRotation: Math.PI,
        materialConfig: { roughness: 3, metalness: 0.0, emissiveIntensity: 0.0 },
        faction: 'Custodian',
        floatBounce: { amplitude: 0.2, speed: 1.0 },
        //wander: { speed: .25, radius: .50, interval: 3 },
